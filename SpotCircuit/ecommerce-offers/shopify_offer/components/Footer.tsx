      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8">
        <div className="xl:grid xl:grid-cols-2 xl:gap-8">
          <div className="space-y-8">
            <Link href="/" className="-m-1.5 p-1.5 flex items-center gap-x-2">
              ...
              />
              <span className="text-2xl font-bold text-white">SpotCircuit</span>
            </Link>
            ...
            <div className="flex space-x-6">
              {navigation.social.map((item) => (
                <Link key={item.name} href={item.href} className="text-gray-400 hover:text-green-400">
          ...
          <div className="mt-16 xl:mt-0">
            ...
            <address className="text-gray-300 not-italic space-y-4">
              <p>19309 Winmeade Drive<br />
              Suite 200<br />
              Landsdowne, VA 20175</p>
              
              <p className="flex items-center gap-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                </svg>
                <a href="tel:+15714790455" className="hover:text-green-400">+1 (571) 479-0455</a>
              </p>
              ...
              <p className="flex items-center gap-x-2">
                ...
                <a href="mailto:info@spotcircuit.com" className="hover:text-green-400">info@spotcircuit.com</a>
              </p>
            </address>
          </div>
        </div>
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-400">
            &copy; {new Date().getFullYear()} SpotCircuit. All rights reserved. Powered by advanced AI technology.
          </p>
        </div>
      </div>
    </footer>
